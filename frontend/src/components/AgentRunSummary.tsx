 ...
 * (``confirmation`` в Т-503, ``skill`` в Т-508, ``stop`` в Т-509) тернарник
 * подписывал их «Моделью» — в ленте читалось «N. Модель Ожидает
 * подтверждения пользователя». Неизвестный вид показывается как есть, чтобы
 * новый шаг не был молча подписан чужим именем.
 */
