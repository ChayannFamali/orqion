...
export const navItems: NavItem[] = [
  ...
  // изменение проверяется внутри. Здесь только параметры рабочей области —
  // личные настройки пользователя (тема, способ отправки) в разделе
  // «Профиль» ниже: другая область действия и другая модель прав.
  { key: "settings", label: "Настройки", icon: Settings, capability: undefined },
  // Т-512: личные настройки пользователя. Отдельный раздел, а не вкладка
  // «Настроек»: другая область действия (один человек, а не рабочая область)
  // и другая модель прав — владение строкой, а не способность роли, поэтому
  // раздел виден каждому аутентифицированному без гейта.
  { key: "profile", label: "Профиль", icon: UserCircle, capability: undefined },
];
